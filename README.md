...
| [Little White Dress](https://little-white-dress-ad94e830edef.herokuapp.com/) | ![Little White Dress](amiresponsive-lwd.webp) | Little White Dress was an idea born out of a real-world need; a close friend who is a wedding planner with a dream to open their own wedding dress store. A visitor to the LWD website can easily browse the products on sale, make a booking to attend the store and try on dresses, and join a community of brides who share recommendations.<br>Built using the Django framework as well as HTML, CSS, JavaScript and Python | Merit |
| [InkPad](https://pp5-kl-c6a010106309.herokuapp.com/) | ![InkPad](responsiveimg.webp) | InkPad is social media platform designed to share, explore and connect with a community of users. The core aim of this web application is to promote and share tattoo designs, and to connect tattoo enthusiasts, artists, and admirers alike.<br>Built using React JS (Back end built using Django REST) | Merit |
---
...
| Reimagining Women's Health | 22nd - 26th April 2024 | [FairPlay](https://api.eu.badgr.io/public/assertions/b8JGTCWgQU-pju9dxPgiGw?identity__email=llewellyn.ksj%40gmail.com)<br>FairPlay is a task sharing partnership tool that aims at tackling the issue of the 'Invisible Load'. <br>The application specifically attempts to make certain life admin duties, that more often than not fall on the shoulders of the materal figure in the household, visible to partners.<br> This is not just a chore sharing application; a partner may login to the app to tick of the cleaning they've done, and in doing so will find other helpful ways to help such as suggesting meal ideas, being aware of children's important developmental stages etc.<br>[Visit the deployed site](https://fairplay-6d713805b8b8.herokuapp.com/) | ![Code Institute - April 2024 Hackathon 2nd Place](https://github.com/llewellynksj/llewellynksj/Code Institute - April 2024 Hybrid Hackathon 2nd Place - 2024-04-29.png)

FairPlay is here to help alleviate the chores, levitate above them and elevate your relationship with your partner to a new emotional level.
